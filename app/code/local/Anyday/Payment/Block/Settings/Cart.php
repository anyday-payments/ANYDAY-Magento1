<?php
class Anyday_Payment_Block_Settings_Cart extends Anyday_Payment_Block_Settings_Abstractsettings
{
    const POSITION_ADPAYMENT_TAG        = 'adpayment_options/cart_page/select_type_tag_product_page';
    const TAG_POSITION_ADPAYMENT_TAG    = 'adpayment_options/cart_page/element_tag';
    ...
    public function isEnableBlock()
    {
        return Mage::helper('adpayment/config')->isEnableTracker() &&
            Mage::helper('adpayment/config')->isEnableTrackInCart();
    }
    ...
    {
        return $this->helperAnyday->getInlineCssCart();
    }
}